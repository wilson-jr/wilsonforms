function notification() {
  ...
  <br>\
  <br>\
  [justify]Уведомляем Вас о том, что Бюро Внутренних Расследований проводит разбирательство с вашим участием. Для получения дополнительной информации, свяжитесь с сержантом Бюро - Дэвидом Асеведой.[/justify]<br>\
  <br>\
  <br>\
  [i]С уважением,<br>\
