function supervisornotification() {
  ...
  <br>\
  <br>\
  Прошу направить характеристику по указанному почтовому адресу в пятидневный срок. Для получения дополнительной информации, свяжитесь с лейтенантом Бюро - Мэттью Айзеком.[/justify]<br><br>\
  <br>\
  <br>\
